 ...
 * @version 1.0
 */
public class PocitadloBodov extends Actor
{
    ...
    public PocitadloBodov()
    {
        this(new String(),"Counter.png");
    }

    /**
     * Create a new counter, initialised to 0.
     */
    public PocitadloBodov(String prefix, String imagePath)
    {
        this.background = new GreenfootImage(imagePath);  // get image from class
        this.value = 0;
        this.prefix = prefix;
        this.updateImage();
    }
